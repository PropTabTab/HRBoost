...
namespace HRBoost.UI.Areas.BusinessManager.Controllers
{
    ...
    public class PersonnelController : Controller
    {
        ...
        public PersonnelController(IUserService userService, IBusinessService businessService)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var çalışanlar = (await _userService.GetAllUsersAsync()).Where(x => x.BusinessId == business.Id);
            return View();
        }
